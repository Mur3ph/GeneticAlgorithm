...
public interface ConsoleMessage 
{
	...
	public final static String[] TODO_LIST = {
												"***************************\n******** TODO LIST ********\n***************************",
												"-- 01). Genetic Algorithm class - Phase 12: Clearing the fitness to begin again with new better population, I think I am adding the previous total with the new total were I should be clearing the previous total and starting with fresh data", 
