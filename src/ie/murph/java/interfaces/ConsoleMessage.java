...
public interface ConsoleMessage 
{
	...
	public final static String[] TODO_LIST = {
												...
												"-- 03). Phase 7 (): I should be using value [p] (i.e. The Tree Map Key, instead I am using fitness [P] Tree Map value )",
												"-- 04). Phase unknown (): Can only chose one offspring per pair of elite candidates AND generate more random parents"
											 };
}
